...
save("ave_A_id1_full_range.txt", 'ave', '-ascii');
save( "L1_A_id1_full_range.txt", 'L1', '-ascii');
save( "L2_A_id1_full_range.txt", 'L2', '-ascii');
save( "L3_A_id1_full_range.txt", 'L3', '-ascii');
